...
-  (یعنی کاربر بدون دغدغه فقط نصب کنه و به تفاوت های توزیع ها کاری نداشته باشه!) تشخیص خودکار توزیع نصب شده
-  (یعنی کاربر بتونه با یک پنل گرافیکی هم انسیبل رو روی سیستمش نصب کنه و هم بتونه لیست نرم افزارها و نسخه هاشون رو ببینه و با چند تا کلیک نصب کنه همه چیزو!)ساختن پنل وب برای مدیریت گرافیکی و راحت تر
- پشتیبانی از سیستم عامل ویندوز!
- (کاربر بتونه بین نسخه ها انتخاب کنه. مثلا داکر نسخه چندشو میخواد یا کوبرنتیز چند یا حتی vscode نسخه چند رو؟)اضافه کردن نسخه بندی برای هر نرم افزار
